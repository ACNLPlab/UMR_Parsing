...
from spring_amr.utils import instantiate_loader, instantiate_model_and_tokenizer, instantiate_model_and_tokenizer_multigen
...
if __name__ == '__main__':
    ...
    print(f"Checkpoint path being used: {args.checkpoint}")
    model.to(device)
    ...
    print("Prediction completed, encoding graphs...")
    pieces = [encode(g) for g in graphs]
    print("Encoding completed, writing file...")
